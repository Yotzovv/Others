...
namespace UltraBetting.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<UltraBettingContext>(options =>
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            RecurringJob.AddOrUpdate("ProcessDownloadXmlData", () => BackgroundTasks.ProcessDownloadXmlData(), Cron.Minutely);
